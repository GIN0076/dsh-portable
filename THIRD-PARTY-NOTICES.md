...
|---|---|---|---|
| [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) | 0.1.0-rc.7 | MIT | The agent framework being packaged. Fetched from upstream, built, kept **zero-modified**. |
